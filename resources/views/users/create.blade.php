...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            <strong>Pakartokite  Slaptažodis:</strong>
            {!! Form::password('confirm-password', array('placeholder' => 'Pakartokite slaptažodi','class' => 'form-control')) !!}
        </div>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
